...
class LoggedInAdminMenu extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    const viewMenuItem = (<span><SearchIcon fontSize="small" className={classes.menuIcoPad} />View</span>);
                      ...
                      <Navbar expand="lg" sticky="top">
                          ...
                          <Navbar.Collapse id="basic-navbar-nav">
                              <Nav className={classes.menuItems}>          
                                  ...
                                  <NavDropdown className={classes.menuItems} href="#" title={createMenuItem}>
                                      <NavDropdown.Item href="/createjob">New Job</NavDropdown.Item>
                                      <NavDropdown.Item href="/createuser">New User</NavDropdown.Item>
                                  </NavDropdown>
                                  <NavDropdown className={classes.menuItems} href="#" title={viewMenuItem}>
                                      <NavDropdown.Item href="/viewjobs">View Jobs</NavDropdown.Item>
                                  ...
                                  <Nav.Link className={classes.menuItems} href="/"><PaidIcon fontSize="small" className={classes.menuIcoPad}/>Billing</Nav.Link>
                                  <Nav.Link className={classes.menuItems} href="/"><PeopleIcon fontSize="small" className={classes.menuIcoPad}/>People</Nav.Link>
                                  <Nav.Link className={classes.menuItems} href="/"><BuildCircleIcon fontSize="small" className={classes.menuIcoPad}/>Admin</Nav.Link>
...
export default connect(mapState, actionCreators)(withStyles(commonStyles)(LoggedInAdminMenu));